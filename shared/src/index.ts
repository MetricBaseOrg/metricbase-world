export const GAME_VERSION = "0.206.3";
...
export * from "./solanaSignature.js";
export * from "./x.js";
export * from "./jobs.js";
export * from "./housing.js";
export * from "./playerZones.js";
export * from "./zoneProps.js";
export * from "./zonePricing.js";
