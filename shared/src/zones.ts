...
export const ZONE_CONFIGS: Record<string, ZoneConfig> = {
  ...
  [ZONE_WILDERNESS]: {
    ...
    npcs: [
      ...
      {
        id: "thorn_slime_1",
        name: "Thornback Slime",
        tileX: 15,
        tileY: 11,
        dialogue: "A bristling slime studded with hardened thorns. Tougher than the little ones — but not a Brute.",
        combat: { maxHp: 95, rewardXp: 45, respawnMs: 12_000 },
      },
      {
        id: "thorn_slime_2",
        name: "Thornback Slime",
