...
export const ITEMS: Record<string, ItemDefinition> = {
  ...
  item_thorn_gel: {
    id: "item_thorn_gel",
    name: "Thorn Gel",
    description: "Barbed, resinous gel from a Thornback Slime. Brenna can hone it into a wicked edge.",
    stackable: true,
    maxStack: 99,
    kind: "material",
  },
  ...
  item_copper_hoe: {
    id: "item_copper_hoe",
    name: "Copper Hoe",
    description: "A sturdy field hoe. Tends crop patches 30% faster; crops you plant grow 15% sooner.",
    stackable: false,
    maxStack: 1,
    kind: "tool",
  },
  item_iron_hoe: {
    id: "item_iron_hoe",
    name: "Iron Hoe",
    description: "A hardened field hoe. Tends crop patches 50% faster; crops you plant grow 25% sooner.",
    stackable: false,
    maxStack: 1,
    kind: "tool",
  },
  item_steel_hoe: {
    ...
    name: "Steel Hoe",
    description:
      "A master farmer's hoe. Tends 50% faster, often yields a bonus harvest; crops grow 35% sooner.",
    stackable: false,
    maxStack: 1,
    kind: "tool",
  },
  item_farmer_hat: {
    ...
    description: "A wide straw hat for long days in the field. +10% Farming XP and sometimes a bonus crop.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  item_grower_ring: {
    id: "item_grower_ring",
    name: "Grower's Ring",
    description: "Amber and gemstone set in a band. +25% Farming XP while worn.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  ...
  item_thorn_cleaver: {
    id: "item_thorn_cleaver",
    name: "Thorn Cleaver",
    description: "A steel cleaver barbed with hardened thorn gel. +36 attack damage — the step before an Ember Blade.",
    stackable: false,
    maxStack: 1,
    kind: "weapon",
  },
  ...
  item_ember_helm: {
    id: "item_ember_helm",
    name: "Ember Helm",
    description: "Forged around a still-burning Ember Core. The heat never quite leaves the steel.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  item_ember_chest: {
    id: "item_ember_chest",
    name: "Ember Cuirass",
    description: "Plates quenched in slime-fire. Heavier than steel, and far harder to dent.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  item_ember_gloves: {
    id: "item_ember_gloves",
    name: "Ember Gauntlets",
    description: "Ember-lined gauntlets that shrug off a Brute's counter-blow.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  item_ember_boots: {
    id: "item_ember_boots",
    name: "Ember Greaves",
    description: "Greaves banded with cooled ember-steel.",
    stackable: false,
    maxStack: 1,
    kind: "armor",
  },
  item_ember_blade: {
    id: "item_ember_blade",
    name: "Ember Blade",
    description: "A blade with an Ember Core set into the hilt. It hums with trapped heat.",
    stackable: false,
    maxStack: 1,
    kind: "weapon",
  },
  item_obsidian_blade: {
    ...
    name: "Obsidian Edge",
    description: "Struck from a shard of the Charred Sentinel itself. The finest blade in the world.",
    stackable: false,
    maxStack: 1,
    kind: "weapon",
  },
