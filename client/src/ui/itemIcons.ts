...
const ITEM_ART: Record<string, [Shape, keyof typeof MATS | "auto"]> = {
  ...
  // fish species (rarity catches)
  item_bluegill: [fish, "steel"],
  item_carp: [fish, "amber"],
  item_catfish: [fish, "gray"],
  item_golden_trout: [fish, "gold"],
  item_crystal_koi: [fish, "gem"],
  item_ancient_sturgeon: [fish, "purple"],
  item_pike: [fish, "iron"],
  item_ghostfin_eel: [fish, "white"],
  item_stormray: [fish, "purple"],
  item_abyssal_leviathan: [fish, "red"],
